...
export default function PostCard({ post, business }) {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden bg-white/5 backdrop-blur-xl border-white/10 hover:bg-white/10 hover:border-white/20 transition-all">
        ...
        <div className="p-5">
          ...
          <h3 className="text-lg font-semibold text-white mt-4">{post.title}</h3>
          <p className="text-zinc-300 mt-2 line-clamp-3">{post.content}</p>
          ...
          {business && (
            <div className="mt-4 pt-4 border-t border-white/10 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Unit {business.unit_number}</p>
              </div>
            </div>
          )}
        </div>

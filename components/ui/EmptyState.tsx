...
export function EmptyState({ icon: Icon, title, message, actionLabel, onAction }: EmptyStateProps) {
  return (
    <View className="flex-1 items-center justify-center px-8 py-12">
      ...
      <Text className="text-2xl font-lora-semibold text-brand-ink leading-tight mb-2 text-center">{title}</Text>
      <Text className="text-base font-nunito text-brand-ink-muted leading-relaxed text-center">{message}</Text>
